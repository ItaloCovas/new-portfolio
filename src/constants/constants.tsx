...
export const STACK_ICONS_LIST = [
  ...
  { id: 16, icon: 'tailwind', category: 'lib' },
  { id: 17, icon: 'docker', category: 'infra' },
  { id: 18, icon: 'mongo', category: 'database' },
  { id: 19, icon: 'mysql', category: 'database' },
  { id: 20, icon: 'firebase', category: 'database' },
  { id: 21, icon: 'postgres', category: 'database' },
  { id: 22, icon: 'swagger', category: 'docs' },
  { id: 23, icon: 'figma', category: 'miscellaneous' },
  { id: 24, icon: 'postman', category: 'miscellaneous' },
  { id: 25, icon: 'insomnia', category: 'miscellaneous' },
  { id: 26, icon: 'photoshop', category: 'miscellaneous' },
  { id: 27, icon: 'dbeaver', category: 'miscellaneous' },
  { id: 28, icon: 'windows', category: 'O.S' },
  { id: 29, icon: 'linux', category: 'O.S' }
];
